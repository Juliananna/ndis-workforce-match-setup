...
import { WorkerProfileDrawer } from "../employer/WorkerProfileDrawer";
...
function matchedWorkerToSummary(w: MatchedWorker): WorkerSummary {
  return {
    workerId: w.workerId,
    name: w.name,
    fullName: null,
    ...
    qualifications: null,
    driversLicense: w.driversLicense,
    vehicleAccess: w.vehicleAccess,
    travelRadiusKm: w.travelRadiusKm,
    skills: w.skills,
    avatarUrl: null,
    introVideoUrl: null,
    ...
    minimumPayRate: w.minimumPayRate,
    seekingPlacement: false,
    priorityBoost: w.priorityBoost,
    docsVerifiedPurchased: w.docsVerifiedPurchased,
    refsPurchased: w.refsPurchased,
    docsVerified: w.docsVerifiedPurchased,
    refsVerified: w.refsPurchased,
    lastLoginAt: null,
