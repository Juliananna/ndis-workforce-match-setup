...
export function StepAboutYou({ data, onChange, emailLocked }: Props) {
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2.5 rounded-lg border focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm ${
            emailLocked ? "bg-slate-50 text-slate-500 cursor-not-allowed border-slate-200" : "border-slate-200"
          }`}
        />
        {emailLocked && (
          <p className="text-xs text-slate-400 mt-1">From your account — update it in your profile settings.</p>
        )}
      </div>
