...
```bash
git remote add encore encore://ndis-workforce-match-setup-5d82
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ndis-workforce-match-setup-5d82/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ndis-workforce-match-setup-5d82/settings/integrations/github)
